...
[data-testid="stSidebar"] [data-testid="stNumberInput"] input {background:#fff !important;color:#0f172a !important;-webkit-text-fill-color:#0f172a !important;border-color:#bfdbfe;}
